namespace GameLauncherCore
{
	public static class PatchParameters
	{
		...
		public const string VERSION_HOLDER_FILENAME_POSTFIX = "_version.data";
		...
		public const string PROJECT_LINKS_DIRECTORY = "Links";
		...
		public const string LOG_FILE_NAME = "patcher_log.txt";
		...
		public const string SELF_PATCHER_DIRECTORY = "SelfUpdater";
